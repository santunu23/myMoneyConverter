...
<html lang="en">
  ...
  <div class="form-group mx-sm-3 mb-2">
   ...
   <div class="form-group mx-sm-3 mb-2">
     <input type="text" class="form-control" name="ammount" id="ammount" placeholder="Amount">
  </div>
<input type="submit" name="submit" value="Submit">  
</form> 
<?php 
if($_SERVER["REQUEST_METHOD"]=="POST"){
echo "<h2>Your Converstion result </h2>";
$ammount=$_POST["ammount"];
$sourceid=$_POST["sourceid"];
$currencies=$_POST["currencies"];
$ch=curl_init('http://apilayer.net/api/live?access_key=ebdcd7fc0c0bfafbad3f02c84bfb687b&currencies='.$currencies.'&source=USD&format=1');
...
echo $ammount.' USD = '.$myCurFun.' '.$currencies;
}
?>
    </main>
